 ...
 * server never sends it back); a blank one keeps the saved token only while the
 * URL is unchanged, and the server says so when it is not.
 */
    ...
    <div className="mt-6 grid grid-cols-1 gap-6 text-[13px] lg:grid-cols-[minmax(0,1fr)_280px]">
      <Card className="px-4 pt-4 sm:px-5 sm:pt-5">
        ...
        <Section title="Plex">
          ...
          <Row label="Token" htmlFor="plex_token" help="Kept on the state volume and never sent back to the browser. Leave blank to keep the saved one; a changed URL needs the token again.">
